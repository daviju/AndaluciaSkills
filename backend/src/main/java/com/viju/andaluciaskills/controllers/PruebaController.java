...
public class PruebaController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Prueba creada con éxtito", content = @Content(schema = @Schema(implementation = PruebaDTO.class))),
    ...
    public ResponseEntity<EvaluacionDTO> actualizarValoraciones(@PathVariable Integer IdEvaluacion,
            @RequestBody List<EvaluacionItemDTO> evaluacionItemDTOs) {
    ...
    public ResponseEntity<Boolean> existeEvaluacion(@PathVariable Integer IdPrueba,
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Evaluaciones encontradas con éxtito"),
            @ApiResponse(responseCode = "500", description = "Error del servidor")
    })
